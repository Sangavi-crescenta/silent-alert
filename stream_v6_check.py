...
if 'model' not in st.session_state:
    st.session_state.model = load_model('bilstm_model_600.h5',compile=False)
...
# Initialize placeholder with a default image if not already done
...
def alert_message_on():
    ...
    account_sid = 'ACd8a908b22c0c9f2354a73582ff2a3473'
    auth_token = '9f11478f9dd9b422756c9bcfed9233c0'
